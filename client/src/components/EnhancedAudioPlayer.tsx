      ...
      {showAdvanced && (
        <div className="border-b border-gray-200 p-4">
          <div className="max-w-7xl mx-auto">
            {/* Visualizer */}
            <div className="mb-4">
              <Visualizer playerState={playerState} type="bars" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Mood & Context */}
              <div className="space-y-3">
                <h4 className="text-sm font-medium text-gray-700">Mood & Context</h4>
                <MoodSelector onMoodSelect={handleMoodSelect} currentMood={currentMood} />
              </div>

              {/* Playback Settings */}
              <div className="space-y-3">
                <h4 className="text-sm font-medium text-gray-700">Playback</h4>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`p-2 rounded-full transition-colors ${
              showAdvanced ? 'bg-indigo-100 text-indigo-600' : 'hover:bg-gray-100 text-gray-700'
            }`}
          >
